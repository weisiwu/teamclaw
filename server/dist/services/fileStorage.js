...
export async function saveScreenshot(versionId, imageData) {
...
export async function deleteScreenshotFile(versionId, screenshotUrl) {
    try {
...
export async function listScreenshotFiles(versionId) {
    await ensureDir(SCREENSHOTS_DIR);
