 ...
 */
import { ROLE_WEIGHTS, URGENCY_KEYWORDS } from '../models/message.js';
/**
 * 计算单条消息的优先级
 */
export function calculatePriority(role, urgency) {
 ...
 * @returns 紧急度（1 或 3）
 */
export function detectUrgency(content) {
 ...
 * 构建完整的消息优先级信息
 */
export function enrichMessagePriority(role, content) {
