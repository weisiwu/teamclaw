 ...
 * 获取 Agent 工作空间信息
 */
export function getWorkspaceInfo(agentName: string): WorkspaceInfo {
 ...
 * 检查工作空间是否就绪
 */
export function isWorkspaceReady(agentName: string): boolean {
 ...
 * 检查共享资源是否就绪
 */
export function areSharedResourcesReady(): { skills: boolean; workspace: boolean; memory: boolean } {
